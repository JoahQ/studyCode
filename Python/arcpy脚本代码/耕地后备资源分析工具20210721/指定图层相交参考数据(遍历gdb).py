...
def BatchIntersect(in_path, layer_name,consult_path, out_path):
...
if __name__ == "__main__":
    ...
    consult_pathG = arcpy.GetParameterAsText(2)
    out_pathG = arcpy.GetParameterAsText(3)

    BatchIntersect(in_pathG, layer_nameG,consult_pathG, out_pathG)
