...
def CanChu(in_path,consult_path, out_path):
    cout = 0
    fail = 0
    warning = 0
    fail_list = []
        ...
        try:
            ...
            for consult_fc in consult_fc_list:
                if xzqcode[0] in consult_fc:
                    consult_fc_pathp = os.path.join(consult_path, consult_fc)
                    break
            ...
            for ifc in fc_list:
                ...
                arcpy.AddMessage(infc_path + " 擦除 " + consult_fc_pathp + "...")
                arcpy.Erase_analysis(infc_path, consult_fc_pathp, erase1_path, ".001 Meters")
