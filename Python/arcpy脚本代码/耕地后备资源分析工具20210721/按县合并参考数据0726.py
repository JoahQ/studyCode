...
list35 = ["451026", "451028", "451029", "451030", "451031", "451081", "450102", "450103", "450105", "450107", "450108",
          "450109", "450110", "450123", "450124", "450125", "450126",
          ...
          "451422", "451423", "451424", "451425", "451481", "450223", "450302", "450303", "450304", "450305", "450311",
          "450312", "450321", "450323", "450324", "450325",
...
def mergeFeatureClass(in_path, out_path):
    ...
    for code_xzq in list35:
        try:
            arcpy.AddMessage("=" * 60)
            cout += 1
            arcpy.AddMessage(" (" + str(cout) + ") " + code_xzq + xzqab(code_xzq))
            arcpy.AddMessage("  ")
            merger_path = os.path.join(out_path,"T" + code_xzq + xzqab(code_xzq) + "合并")
            in_merge_list = []
            for workspace in workspaces:
                ...
                for fc in arcpy.ListFeatureClasses():
                    if code_xzq in fc:
                        arcpy.AddMessage("      " + fc)
                        in_merge_list.append(os.path.join(workspace,fc))
                        break
            arcpy.AddMessage(" 开始合并....")
            arcpy.Merge_management(in_merge_list,merger_path)
        except Exception as e:
            arcpy.AddError(e.message)
            arcpy.AddError("    合并" + code_xzq + xzqab(code_xzq) + " 失败！")
            fail_list
            fail += 1
...
if __name__ == "__main__":
    ...
    mergeFeatureClass(in_pathG,out_pathG)