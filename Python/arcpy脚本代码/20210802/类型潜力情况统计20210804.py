...
def statisticsAreaQ3(in_path, out_path, where_clause, name):
    ...
    for workspace in workspaces:
        ...
        try:
            ...
            row_values[2] = row_values[3] + row_values[11] + row_values[15] + row_values[22] + row_values[28]
...
def fastStatisticsAreaQ3(in_path, out_path, where_clause, name):
    cout = 0
    fail = 0
    fail_list = []
...
if __name__ == "__main__":
    ...
    if fastStat:
        ...
        fastStatisticsAreaQ3(in_pathG, out_pathG, whereCG, table_name_global)
    else:
