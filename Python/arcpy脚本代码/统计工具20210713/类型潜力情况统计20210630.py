        ...
        try:
            for iin_fc_path in right_name_path[1]:
                ...
                if "农" in fc or u"农" in fc:
                    out_featuren = os.path.join(result_gdb, getNewFileNameQ(result_gdb, "N" + gdbName))
                    ...
                    out_featurew = os.path.join(result_gdb, getNewFileNameQ(result_gdb, "W" + gdbName))
                    ...
                    out_featureJ = os.path.join(result_gdb, getNewFileNameQ(result_gdb, "J" + gdbName))
                    ...
                    out_featureT = os.path.join(result_gdb, getNewFileNameQ(result_gdb, "T" + gdbName))
