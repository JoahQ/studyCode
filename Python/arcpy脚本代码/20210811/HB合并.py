...
def CanChu(in_path,tdzz_path, name,out_path,out_layername):
    cout = 0
    fail = 0
    warning = 0
    fail_list = []
    ...
    for workspace in workspaces:
        ...
        try:
            ...
            for ifc in fc_list:
                ...
                merger_path = os.path.join(result_gdb,out_layername)
                arcpy.AddMessage(infc_path + "  与 " + tdzz_fc_pathp + " 合并...")
                arcpy.Merge_management([infc_path,tdzz_fc_pathp],merger_path)
        except Exception as e:
            arcpy.AddError(e.message)
            arcpy.AddError("    合并" + os.path.basename(workspace) + " 失败！")
...
if __name__ == "__main__":
    ...
    llllname = arcpy.GetParameterAsText(4)

    CanChu(in_pathG,tdzz_pathG,nameG,out_pathG,llllname)
